...
import com.movie_hub.android.databinding.ItemCollectionType2Binding;
import com.movie_hub.android.ui.main.home.OnMovieClickCallback;

import java.util.ArrayList;
import java.util.List;

public class CollectionType_2_Adapter extends RecyclerView.Adapter<CollectionType_2_Adapter.CollectionType_2_ViewHolder> {

    private final List<MovieResponse> items = new ArrayList<>();
    private OnMovieClickCallback listener;
    private Context context;

    public CollectionType_2_Adapter(OnMovieClickCallback listener, Context context) {
        super();
    ...
    @NonNull
    @Override
    public CollectionType_2_ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        ItemCollectionType2Binding binding = ItemCollectionType2Binding.inflate(inflater, parent, false);
        return new CollectionType_2_ViewHolder(binding);
    }
    private int lastPosition = -1;

    @SuppressLint({"SetTextI18n", "ResourceAsColor", "ClickableViewAccessibility"})
    @Override
    public void onBindViewHolder(@NonNull CollectionType_2_ViewHolder holder, @SuppressLint("RecyclerView") int position) {
    ...
    static class CollectionType_2_ViewHolder extends RecyclerView.ViewHolder {
        private final ItemCollectionType2Binding binding;

        public CollectionType_2_ViewHolder(@NonNull ItemCollectionType2Binding binding) {
