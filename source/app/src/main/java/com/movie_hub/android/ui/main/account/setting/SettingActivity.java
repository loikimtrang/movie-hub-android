...
public class SettingActivity extends BaseActivity<ActivitySettingAccountBinding, SettingViewModel> implements SystemBarColorProvider {
    @Override
    ...
    private List<SettingAccountModel> resolutionList = new ArrayList<>();
    ...
    private void setupPlaySpeedSeekBar() {
        ...
        viewBinding.seekBarPlaySpeed.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                viewBinding.tvPlaySpeed.setText(String.format(Locale.US, "%.2fx", speed));
                viewModel.setting.setPlaybackSpeed((double) speed);
            }
    ...
    private void setupBrightnessSeekBar() {
        ...
        int oldBrightness = (viewModel.setting.getBrightness() != null) ? viewModel.setting.getBrightness() : 50;
    ...
    private void setupVolumeSeekBar() {
        ...
        int oldVol = (viewModel.setting.getAudio() != null) ? viewModel.setting.getAudio() : audioManager.getStreamVolume(AudioManager.STREAM_MUSIC);
    ...
    public void updateSetting() {
        ...
        viewModel.updateSetting(new MainCallback<ResponseWrapper>() {
            ...
            public void doSuccess(ResponseWrapper responseWrapper) {
                hideLoading();
                new ToastMessage(ToastMessage.TYPE_NORMAL, getString(R.string.setting_have_been_success_update)).showMessage(getApplicationContext());
            }
