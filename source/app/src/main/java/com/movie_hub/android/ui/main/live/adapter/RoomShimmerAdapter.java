...
public class RoomShimmerAdapter extends RecyclerView.Adapter<RoomShimmerAdapter.ViewHolder> {
    private final int shimmerItemCount;

    public RoomShimmerAdapter(int count) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_room_shimmer, parent, false);
