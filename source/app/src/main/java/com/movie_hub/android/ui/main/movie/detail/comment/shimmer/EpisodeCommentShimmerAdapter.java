package com.movie_hub.android.ui.main.movie.detail.comment.shimmer;
...
public class EpisodeCommentShimmerAdapter extends RecyclerView.Adapter<EpisodeCommentShimmerAdapter.ViewHolder> {
    private final int shimmerItemCount;
    private Context context;
    public EpisodeCommentShimmerAdapter(int count, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_episode_comment_shimmer, parent, false);
