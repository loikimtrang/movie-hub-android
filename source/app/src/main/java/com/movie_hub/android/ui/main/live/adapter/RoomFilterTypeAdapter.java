...
public class RoomFilterTypeAdapter extends RecyclerView.Adapter<RoomFilterTypeAdapter.RoomFilterTypeViewHolder> {
    ...
    public RoomFilterTypeAdapter(OnFilterTopClickListener listener, Context context) {
        super();
    ...
    @NonNull
    @Override
    public RoomFilterTypeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemTopHomeFilterBinding binding = ItemTopHomeFilterBinding.inflate(
                LayoutInflater.from(parent.getContext()), parent, false);
        return new RoomFilterTypeViewHolder(binding);
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(@NonNull RoomFilterTypeViewHolder holder, int position) {
    ...
    static class RoomFilterTypeViewHolder extends RecyclerView.ViewHolder {
        final ItemTopHomeFilterBinding binding;

        public RoomFilterTypeViewHolder(ItemTopHomeFilterBinding binding) {
